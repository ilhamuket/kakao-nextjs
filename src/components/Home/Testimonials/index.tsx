        ...
        <section id="testimonial">
            <div className='container mx-auto lg:max-w-screen-xl md:max-w-screen-md px-4'>
                <div className="text-center mb-10">
                    <h2 className="text-3xl font-bold text-darkbrown">Testimonials</h2>
                    <p className="text-lightgray mt-2">What they say about us</p>
                </div>
                <Slider {...settings}>
                    {TestimonialData.map((items, i) => (
                        <div key={i}>
                            <div className={`bg-white rounded-2xl m-4 p-5 my-20 relative ${i % 2 ? 'shadow-testimonial-green' : 'shadow-testimonial-brown'}`}>
